...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("mud"), bytes16("AuraEmitter"))));
uint256 constant AuraEmitterTableId = _tableId;
...
library AuraEmitter {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AuraEmitter", _fieldNames);
  }
