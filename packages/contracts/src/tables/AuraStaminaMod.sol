...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("mud"), bytes16("AuraStaminaMod"))));
uint256 constant AuraStaminaModTableId = _tableId;

library AuraStaminaMod {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AuraStaminaMod", _fieldNames);
  }
