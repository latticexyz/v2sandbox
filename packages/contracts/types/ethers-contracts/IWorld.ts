...
export type PositionTableDataStruct = {
  x: PromiseOrValue<BigNumberish>;
  y: PromiseOrValue<BigNumberish>;
  z: PromiseOrValue<BigNumberish>;
};

export type PositionTableDataStructOutput = [number, number, number] & {
  x: number;
  y: number;
  z: number;
};
...
export interface IWorldInterface extends utils.Interface {
  functions: {
    ...
    "mud_move_move(int32,int32,int32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mud_move_move",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>
...
export interface IWorld extends BaseContract {
  ...
  callStatic: {
    ...
    mud_move_move(
      ...
      z: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<PositionTableDataStructOutput>;
